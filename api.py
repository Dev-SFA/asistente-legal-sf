...
def generate_final_response(query, context, history):
    ...
    system_prompt = (
        ...
        f"3. **Fase 2 (Análisis VENDEDOR y CTA):** SOLO después de recopilar los 5 hechos + Edad, ofrece un análisis preliminar de **Nivel 8 (semi-profundo)**, que sea el valor central de la interacción. Este análisis DEBE: \n"
        "   - **Identificar la Rama Legal** (ej. Derecho de Familia).\n"
        "   - **Señalar el Problema Central y el Derecho Vulnerado** (ej. Incumplimiento del derecho a la integridad familiar).\n"
